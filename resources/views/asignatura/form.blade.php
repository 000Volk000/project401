<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="id_ciudad" class="form-label">{{ __('Idciudad') }}</label>
            <input type="text" name="idCiudad" class="form-control @error('idCiudad') is-invalid @enderror" value="{{ old('idCiudad', $asignatura?->idCiudad) }}" id="id_ciudad" placeholder="Idciudad">
